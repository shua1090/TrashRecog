...
#  -------------------------------------------------------------
"""
Generated by Lobe - Will be used for the classification of images on Trash Classifier.
Average 15-17 milliseconds per generic image inference.
"""
import argparse
import json
import os
...
MODEL_DIR = os.path.join(os.path.dirname(__file__),
                         "../resources")  # default assume that our export is in this file's parent directory
...
class Model(object):
    def __init__(self, model_dir=MODEL_DIR):
        ...
        with open(os.path.join(model_path, "../resources/signature.json"), "r") as f:
    ...
    def load(self):
        ...
        tf.compat.v1.saved_model.loader.load(sess=self.session, tags=self.signature.get("tags"),
